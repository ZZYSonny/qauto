...
class AISpeechAudioController extends AudioController{
  ...
  @override
  Future<int> listenForSentences(List<String> expectedAnswers, [bool allowNoResult = true]) async {
    ...
    log(result);
    int id = expectedAnswers.indexOf(result);
    return id;
  }

  @override
  Future<void> readSentence(String text) async{
    log(text);
